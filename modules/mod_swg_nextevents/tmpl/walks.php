  ...
  <ul>
    <?php foreach ($events as $event):?>
      <li id="walk_<?php echo $event->id; ?>" class="<?php if ($event->alterations->cancelled) echo "cancelled"; else if ($event->alterations->anyAlterations()) echo " altered";?>">
        ...
        <h4>
          <a href="<?php echo $listPage."#walk_".$event->id?>" class="eventinfopopup" rel="walk_<?php echo $event->id; ?>"><?php echo $event->name; ?></a><span class="rating">&nbsp;(<?php echo $event->miles;?> miles)</span>
        </h4>
      </li>
    <?php endforeach; ?>
  </ul>
