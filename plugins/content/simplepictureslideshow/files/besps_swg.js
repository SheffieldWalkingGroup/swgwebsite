 ...
 * SWG template modifications
 * Adds JS start & stop commands
 * Only runs the slideshow when not on a mobile site
 * Auto-resize the images to fit the page while keeping the correct ratio
 */
...
//push images into array and get things going
	this.b_myfade = function(){
		...
		for(a=1;a<=emax;a++){
			...
			// SWG: Only preload if not mobile
			if (preload && a==emax && !document.body.hasClass("mobile"))
			{
